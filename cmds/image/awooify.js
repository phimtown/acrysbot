...
module.exports.run = async (bot, msg, args) => {
    ...
    if(args[0] && msg.mentions.members.size >= 1) {
        ...
        needle.get(`https://nekobot.xyz/api/imagegen?type=awooify&url=${u1.displayAvatarURL({ dynamic: true, format: 'png', size: 2048 })}`, function(err, res) {
...
module.exports.help = {
  name: "awooify",
  arguments: "@user",
  description: "awooify someone. \n@user: mention of user you want to awooify.",
  category: "image"
}
