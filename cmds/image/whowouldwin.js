...
module.exports.run = async (bot, msg, args) => {
    ...
    if(args[0] && msg.mentions.members.size >= 2) {
        ...
        needle.get(`https://nekobot.xyz/api/imagegen?type=whowouldwin&user1=${u1.displayAvatarURL({ dynamic: true, format: 'png', size: 2048 })}&user2=${u2.displayAvatarURL({ dynamic: true, format: 'png', size: 2048 })}`, function(err, res) {
